...
1. Source link: [Balance Scale Data Set](https://archive.ics.uci.edu/ml/datasets/Balance+Scale)

2. Source Information: 
    - Source: Generated to model psychological experiments reported
		by Siegler, R. S. (1976).  Three Aspects of Cognitive
		Development.  Cognitive Psychology, 8, 481-520.
    - Donor: Tim Hume (hume@ics.uci.edu)
    - Date: 22 April 1994

3. Publication: (possibly different formats of this data)
